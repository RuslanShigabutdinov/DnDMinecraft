    ...
    public function run(): void
    {
        ...
        foreach ($statBonuses as [$slug, $value]) {
            ...
            ClassBonus::firstOrCreate(
                ['class_id' => $medic->id, 'modifiable_type' => $stat->getMorphClass(), 'modifiable_id' => $stat->id],
                ['value' => $value],
            );
        }
        ...
        foreach ($abilityBonuses as [$slug, $value]) {
            ...
            ClassBonus::firstOrCreate(
                ['class_id' => $medic->id, 'modifiable_type' => $ability->getMorphClass(), 'modifiable_id' => $ability->id],
                ['value' => $value],
            );
        }
        ...
        foreach ($skillBonuses as [$slug, $value]) {
            ...
            ClassBonus::firstOrCreate(
                ['class_id' => $medic->id, 'modifiable_type' => $skill->getMorphClass(), 'modifiable_id' => $skill->id],
                ['value' => $value],
            );
        }
