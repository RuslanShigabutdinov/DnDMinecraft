    ...
    public function run(): void
    {
        ...
        foreach ($statBonuses as [$slug, $value]) {
            ...
            ClassBonus::firstOrCreate(
                ['class_id' => $scholar->id, 'modifiable_type' => Stat::class, 'modifiable_id' => $stat->id],
                ['value' => $value],
            );
        }
        ...
        foreach ($abilityBonuses as [$slug, $value]) {
            ...
            ClassBonus::firstOrCreate(
                ['class_id' => $scholar->id, 'modifiable_type' => Ability::class, 'modifiable_id' => $ability->id],
                ['value' => $value],
            );
        }
        ...
        foreach ($skillBonuses as [$slug, $value]) {
            ...
            ClassBonus::firstOrCreate(
                ['class_id' => $scholar->id, 'modifiable_type' => Skill::class, 'modifiable_id' => $skill->id],
                ['value' => $value],
            );
        }
